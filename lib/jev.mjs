...
export function readConfig(env = process.env) {
  ...
  return {
    ...
    // Per-gate switches: JEV_GATES_RULES, _SCOPE, _DONE, _CLAIMS, _INTENT, _COMMIT = off
    gates: Object.fromEntries(["RULES", "SCOPE", "DONE", "CLAIMS", "INTENT", "COMMIT"].map((g) => [g.toLowerCase(), env[`JEV_GATES_${g}`] !== "off"])),
    // Storage
