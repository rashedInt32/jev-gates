...
const OPT_IN = new Set(["RULES", "SCOPE"]);
...
export function readConfig(env = process.env) {
  ...
  return {
    ...
    // Per-gate switches: JEV_GATES_DONE, _CLAIMS, _PROOF, _INTENT, _COMMIT = off.
    // Rules and scope are opt-in (JEV_GATES_RULES=on, _SCOPE=on): they ask before edits, and in real use
    // they interrupted far more often than they caught anything.
